                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control mb-3" id="kode" placeholder="Kode Kelompok Produk" name="kode" value="{{ old('kode',$foodCategory->kode) }}" onkeyup="this.value = this.value.toUpperCase()" required autofocus>
                          ...
                          <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control mb-3" id="nama" placeholder="Nama Kelompok Produk" name="nama" value="{{ old('nama',$foodCategory->nama) }}" onkeyup="this.value = this.value.toUpperCase()" required>
